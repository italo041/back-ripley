...
const firstName = joi_1.default.string().trim().min(3).max(15).regex(/^[a-zA-Z]*$/).example('John');
const lastName = joi_1.default.string().trim().min(3).max(15).regex(/^[a-zA-Z]*$/).example('Doe');
const birthday = joi_1.default.date().min('1930-01-01').max(Date.now()).example('1998-10-10');
